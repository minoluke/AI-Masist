...
### 2026-01-05
- **LLM-as-a-Judge機能を追加**: シミュレーション中に会話ログや行動履歴などの定性データをLLMで定量評価できるように
  - ルーブリック（評価基準）に基づく2〜3段階評価をサポート
  - 評価結果はスコアと根拠（evidence）としてmetricsに保存
  - コード生成プロンプトにリファレンスを自動付与し、適切な使用をガイド
